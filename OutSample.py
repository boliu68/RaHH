...
def OutSample_Test(Tr_img, Tr_tag, Tr_sim, Tst_img, Tst_qa, W, S, H_img_Tr, H_tag_Tr, gd):
    ...
    [H_Al_img, qa_nouse, W_nouse, S_nouse, Rp_Al_img, Rq_Al_img, A_img_nouse, A_qa_nouse] = initialize(Al_img, Tr_tag, img_sim)
    ...
    [img_nouse, H_Al_tag, W_nouse, S_nose, Rp_Al_tag, Rq_Al_tag, A_img_nouse, A_qa_nouse] = initialize(Tr_img, Al_tag, tag_sim)
